...
impl Ws2812b {
    /// How many colors should be sent.
    ...
    pub async fn set_colors(&mut self, colors: &[Color; Self::COLOR_COUNT]) -> embassy_time::Timer {
        ...
        let mut dma_buffer = [const { MaybeUninit::<u8>::uninit() }; Self::COLOR_COUNT * 3 * 4];
        ...
        let dma_buffer: [u8; Self::COLOR_COUNT * 3 * 4] = unsafe { transmute(dma_buffer) };
